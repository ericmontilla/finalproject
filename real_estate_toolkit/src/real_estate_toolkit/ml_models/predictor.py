...
class HousePricePredictor:
    ...
    def prepare_features(self, target_column: str = 'SalePrice', selected_predictors: List[str] = None):
        ...
        try:
            ...
            # Separate the numeric and cathegorical columns
            ...
            # Mix the numerical and cathegorical pipelines
    ...
    def train_baseline_models(self) -> Dict[str, Dict[str, Any]]:
        ...
        try:
            ...
            self.baseline_models = results  # Ensure of saving yhe models in the baseline_models dictionary 
...
if __name__ == "__main__":
    ...
    if not train_data_path.exists():
        ...
        try:
            ...
            # Mostrar las métricas de los modelos entrenados
            ...
            # Generar predicciones usando el modelo avanzado (Gradient Boosting)
            print("\nGenerating predictions using the Advanced model...\n")
            predictor.forecast_sales_price(model_type="Advanced")

        except Exception as e:
            print(f"Error in the main execution flow: {e}")
            print("\n\n**DEBUGGING INFORMATION**\n")
            print(f"predictor.full_transformer: {predictor.full_transformer}")
            print(f"predictor.selected_predictors: {predictor.selected_predictors}")
            print(f"predictor.test_data.columns: {predictor.test_data.columns}")
            print(f"predictor.test_data.dtypes: {predictor.test_data.dtypes}")
